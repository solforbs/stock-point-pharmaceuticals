...
class SaleLine extends Model
{
    ...
    protected $fillable = [
        'sale_id', 'line_number', 'product_id', 'uom_id', 'qty', 'qty_base',
        'list_price', 'unit_price', 'discount_amount', 'discount_pct', 'discount_source', 'approved_by',
        'tax_code_id', 'tax_rate', 'tax_amount', 'line_total',
        'unit_cost', 'line_cost', 'is_bonus', 'fefo_overridden', 'override_reason',
    ];
