...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('sales_order_lines', function (Blueprint $table) {
            ...
            // Filled progressively as the order moves through confirm -> pick -> dispatch.
            $table->decimal('qty_reserved_base', 18, 4)->default(0);
            $table->decimal('qty_picked_base', 18, 4)->default(0);
            $table->decimal('qty_dispatched_base', 18, 4)->default(0);
