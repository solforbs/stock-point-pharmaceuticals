 ...
 */
class MrlPricelistRemainderSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if (! $eaUomId) {
            throw new \RuntimeException('UnitOfMeasureSeeder must run before MrlPricelistRemainderSeeder (EA unit not found).');
        }

        $path = __DIR__.'/data/mrl_pricelist_2026_remainder.json';
