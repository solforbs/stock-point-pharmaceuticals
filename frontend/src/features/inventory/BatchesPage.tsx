...
export default function BatchesPage() {
  ...
  const columns: Column<ProductBatch>[] = [
    { key: 'batch', header: 'Batch', render: (b) => <span className="font-semibold tabular text-[var(--color-navy)] dark:text-blue-400">{b.batch_number}</span>, sortValue: (b) => b.batch_number },
