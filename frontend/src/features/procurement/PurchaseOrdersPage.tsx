...
export default function PurchaseOrdersPage() {
  ...
  const columns: Column<PurchaseOrder>[] = [
    { key: 'doc', header: 'Document', render: (po) => <span className="font-semibold tabular text-[var(--color-navy)] dark:text-blue-400">{po.doc_number}</span>, sortValue: (po) => po.doc_number },
