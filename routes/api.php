...
Route::middleware(['auth:sanctum', 'branch.context'])->group(function () {
    ...
    Route::patch('/locations/{location}', [\App\Http\Controllers\Api\LocationController::class, 'update']);
    Route::get('/locations/{location}/stock', [\App\Http\Controllers\Api\LocationController::class, 'stock']);
    Route::get('/packing/queue', [\App\Http\Controllers\Api\PackingController::class, 'queue']);
    Route::post('/picking-lists/{list}/pack', [\App\Http\Controllers\Api\PackingController::class, 'pack']);
    Route::get('/customer-contacts', [\App\Http\Controllers\Api\CustomerContactController::class, 'index']);
    Route::post('/customer-contacts', [\App\Http\Controllers\Api\CustomerContactController::class, 'store']);
    Route::patch('/customer-contacts/{contact}', [\App\Http\Controllers\Api\CustomerContactController::class, 'update']);
    Route::get('/customer-interactions', [\App\Http\Controllers\Api\CustomerContactController::class, 'interactions']);
    Route::post('/customer-interactions', [\App\Http\Controllers\Api\CustomerContactController::class, 'storeInteraction']);
    Route::patch('/customer-interactions/{interaction}', [\App\Http\Controllers\Api\CustomerContactController::class, 'updateInteraction']);
    Route::get('/finance/reconciliation', [\App\Http\Controllers\Api\ReconciliationController::class, 'index']);
    Route::post('/finance/reconciliation/reconcile', [\App\Http\Controllers\Api\ReconciliationController::class, 'reconcile']);
    Route::post('/finance/reconciliation/{payment}/unreconcile', [\App\Http\Controllers\Api\ReconciliationController::class, 'unreconcile']);
    Route::get('/customers/{customer}/statement', [\App\Http\Controllers\Api\CustomerStatementController::class, 'show']);

    // Quality & Compliance — cold chain (Part 8.5), ADR (Part 11.4), licences and SOPs (V6 Parts 16.3, 16.4)
    Route::get('/cold-chain/summary', [\App\Http\Controllers\Api\ColdChainController::class, 'summary']);
    Route::get('/cold-chain/readings', [\App\Http\Controllers\Api\ColdChainController::class, 'readings']);
    Route::post('/cold-chain/readings', [\App\Http\Controllers\Api\ColdChainController::class, 'storeReading']);
    Route::get('/cold-chain/excursions', [\App\Http\Controllers\Api\ColdChainController::class, 'excursions']);
    Route::get('/cold-chain/excursions/{excursion}', [\App\Http\Controllers\Api\ColdChainController::class, 'excursion']);
    Route::post('/cold-chain/excursions/{excursion}/review', [\App\Http\Controllers\Api\ColdChainController::class, 'reviewExcursion']);
    Route::post('/cold-chain/excursions/{excursion}/close', [\App\Http\Controllers\Api\ColdChainController::class, 'closeExcursion']);
    Route::get('/adr-reports', [\App\Http\Controllers\Api\AdrReportController::class, 'index']);
    Route::post('/adr-reports', [\App\Http\Controllers\Api\AdrReportController::class, 'store']);
    Route::get('/adr-reports/{report}', [\App\Http\Controllers\Api\AdrReportController::class, 'show']);
    Route::patch('/adr-reports/{report}', [\App\Http\Controllers\Api\AdrReportController::class, 'update']);
    Route::post('/adr-reports/{report}/submit', [\App\Http\Controllers\Api\AdrReportController::class, 'submit']);
    Route::post('/adr-reports/{report}/close', [\App\Http\Controllers\Api\AdrReportController::class, 'close']);
    Route::get('/licences', [\App\Http\Controllers\Api\LicenceController::class, 'index']);
    Route::get('/licences/holders', [\App\Http\Controllers\Api\LicenceController::class, 'holders']);
    Route::post('/licences', [\App\Http\Controllers\Api\LicenceController::class, 'store']);
    Route::match(['post', 'patch'], '/licences/{licence}', [\App\Http\Controllers\Api\LicenceController::class, 'update']);
    Route::get('/licences/{licence}/document', [\App\Http\Controllers\Api\LicenceController::class, 'document']);
    Route::get('/documents', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'index']);
    Route::post('/documents', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'store']);
    Route::get('/documents/{document}', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'show']);
    Route::patch('/documents/{document}', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'update']);
    Route::post('/documents/{document}/versions', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'storeVersion']);
    Route::get('/documents/{document}/versions/{version}/download', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'download']);
    Route::post('/documents/{document}/activate', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'activate']);
    Route::post('/documents/{document}/retire', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'retire']);
    Route::post('/documents/{document}/acknowledge', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'acknowledge']);
    Route::get('/documents/{document}/acknowledgements', [\App\Http\Controllers\Api\ControlledDocumentController::class, 'acknowledgements']);
