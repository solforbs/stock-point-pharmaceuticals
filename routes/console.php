...
// Part 20.3 — archived report runs are kept for REPORT_RUN_RETENTION_DAYS (180 by default).
Schedule::command('reports:prune-runs')->dailyAt('03:15')->withoutOverlapping();
